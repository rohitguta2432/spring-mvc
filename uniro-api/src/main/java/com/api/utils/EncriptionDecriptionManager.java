...
public class EncriptionDecriptionManager {
    ...
    public EncriptionDecriptionManager() throws UnsupportedEncodingException, NoSuchPaddingException, NoSuchAlgorithmException {
